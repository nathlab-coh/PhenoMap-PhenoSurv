...
```{r}
pc <- rbind(read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//lung_train_data_MSK_FINAL.csv'))
...
df_hr <- data.frame("Phenotype" = rep(c("DNA REPAIR", "EVADE GROWTH SUPPRESSORS", "HORMONE SIGNALING", "IMUNE", "INFLAMMATION", "PLASTICITY",
                    ...
                    "COEF" = c(-0.5602, 0.6261, 0.2761, -0.5258, 0.1584, 0.8046, 0.2830, 0.6023, -0.3345, 0.2627, 0.6396),
                    "SE" = c(0.2737, 0.2677, 0.2798, 0.2479, 0.2956, 0.2657, 0.3149, 0.2632, 0.3434, 0.2872, 0.3265))
...
msk_plot <- ggplot(df, aes(y = Phenotype, x = COEF, group = Subtype)) +
              geom_point(aes(group = Subtype), position = position_dodge(width=0.75), color = "#1E88E5") +
...
top = 10
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_dna_repair_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_growth_suppressor_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_hormone_signaling_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_immune_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_inflammation_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_metabolism_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_metastasis_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_plasticity_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_proliferation_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_resist_cell_death_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_vasculator_MSK_FINAL_lung.csv')
pathways <- shap_values$Pathway
shap_values <- shap_values[,-ncol(shap_values)]
shap_values <- apply(shap_values, 2, abs)
shap_mean <- apply(shap_values, 1, mean)
...
```{r}
tcga_hormone_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_hormone_signaling_MSK_FINAL_lung.csv')
tcga_hormone_shap_values <- subset(tcga_hormone_shap_values, Pathway %in% subset(df_pheno_pc, Group == "HORMONE SIGNALING")$Pathway)
tcga_growth_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_growth_suppressor_MSK_FINAL_lung.csv')
...
tcga_proliferation_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_proliferation_MSK_FINAL_lung.csv')
...
tcga_resist_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_resist_cell_death_MSK_FINAL_lung.csv')
tcga_resist_shap_values <- subset(tcga_resist_shap_values, Pathway %in% subset(df_pheno_pc, Group == "RESIST CELL DEATH")$Pathway)
tcga_immune_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_immune_MSK_FINAL_lung.csv')
tcga_immune_shap_values <- subset(tcga_immune_shap_values, Pathway %in% subset(df_pheno_pc, Group == "IMMUNE")$Pathway)
tcga_vasculature_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_vasculator_MSK_FINAL_lung.csv')
tcga_vasculature_shap_values <- subset(tcga_vasculature_shap_values, Pathway %in% subset(df_pheno_pc, Group == "VASCULATURE")$Pathway)
tcga_metastasis_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_metastasis_MSK_FINAL_lung.csv')
tcga_metastasis_shap_values <- subset(tcga_metastasis_shap_values, Pathway %in% subset(df_pheno_pc, Group == "METASTASIS")$Pathway)
tcga_dna_repair_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_dna_repair_MSK_FINAL_lung.csv')
tcga_dna_repair_shap_values <- subset(tcga_dna_repair_shap_values, Pathway %in% subset(df_pheno_pc, Group == "DNA REPAIR")$Pathway)
tcga_inflammation_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_inflammation_MSK_FINAL_lung.csv')
...
tcga_plasticity_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_plasticity_MSK_FINAL_lung.csv')
tcga_plasticity_shap_values <- subset(tcga_plasticity_shap_values, Pathway %in% subset(df_pheno_pc, Group == "PLASTICITY")$Pathway)
tcga_metabolism_shap_values <- read.csv('~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_shapvalues_metabolism_MSK_FINAL_lung.csv')
...
```{r}
library(ggbeeswarm)
test_cols <- read.csv("~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_values_MSK_FINAL_lung_pathwaynames.csv")
test_vals <- read.csv("~//Documents//Survival VAE//FINAL PHENOSURV//v2//test_values_MSK_FINAL_lung.csv")
...
```{r}
ggsave("~//Documents//Survival VAE//Figures//v3//lung shap plot msk.svg", plot = hr_bs_plot, bg = "transparent", width = 10, height = 6)
```
